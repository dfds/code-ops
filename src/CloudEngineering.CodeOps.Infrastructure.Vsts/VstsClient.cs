...
using CloudEngineering.CodeOps.Infrastructure.Vsts.Http.Request.Build;
using CloudEngineering.CodeOps.Infrastructure.Vsts.Http.Request.Build.Definition;
using CloudEngineering.CodeOps.Infrastructure.Vsts.Http.Request.Profile;
using CloudEngineering.CodeOps.Infrastructure.Vsts.Http.Request.Project;
using CloudEngineering.CodeOps.Infrastructure.Vsts.Http.Request.Release;
